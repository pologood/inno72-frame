...
public class LocalDateTimeUtil {
	...
	public static Date toDate(LocalDateTime localDateTime, ZoneOffset zoneOffset) {
		Date result = Date.from(localDateTime.toInstant(zoneOffset));
		return result;
	}
	...
	public static long transfer2Long(LocalDateTime localDateTime) {
		return localDateTime.toInstant(ZoneOffset.UTC).toEpochMilli();
	}

	/**
	 * 将时间戳转换为{@linkplain LocalDateTime 时间}
	 * 
	 * @param timestamp
	 * @return
	 * @author Houkm 2017年9月27日
	 */
	 ...
	 * @author Houkm 2017年9月27日
	 */
	public static LocalDateTime long2LocalDateTime(long timestamp, int nanoseconds) {
		return LocalDateTime.ofEpochSecond(timestamp, nanoseconds, ZoneOffset.UTC);
	}
