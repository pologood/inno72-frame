...
import com.inno72.alarm.center.mapper.DepartmentMapper;
import com.inno72.alarm.center.mapper.UserMapper;
import com.inno72.alarm.center.model.Department;
import com.inno72.alarm.center.service.UserService;
import com.inno72.common.Result;
import com.inno72.common.Results;
import com.inno72.config.client.MemcachedKeysProperties;
import com.inno72.ddtalk.user.UserHandler;
...
public class UserServiceImpl implements UserService {
	...
	public Result<JSONObject> get(String token) {
		...
		com.inno72.alarm.center.model.User userMap = userMapper.selectByPrimaryKey(id);
